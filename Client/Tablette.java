...
class Tablette extends JFrame {
	private int numClient;
	private int recap ; 
	
	public Tablette(int numClient0,int recap0) {
		recap = recap0;
		...
		JRadioButton positif = new JRadioButton("Oui");
		...
		group.add(negatif);
		negatif.addItemListener(new ControleChoixTablette(negatif,positif,numClient,"non"));
		group.add(positif);
		positif.addItemListener(new ControleChoixTablette(negatif,positif,numClient,"non"));
