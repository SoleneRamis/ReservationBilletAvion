...
public class Recapitulatif extends JFrame {
	...
	private JLabel label8 = new JLabel("Magazines");
	private JLabel label9 = new JLabel("Informations importantes pour le personnel?:");


	
	private int numClient ; 
	
	public Recapitulatif(int numClient0){
		...
		container.add(haut3,BorderLayout.CENTER); 
		JPanel bas = new JPanel(new BorderLayout());
		haut3.add(bas);
		bas.setLayout(new GridLayout(9,1));
		...
		bashaut8.setLayout(new GridLayout(1,3));
		//panneau pour label1
		JPanel bashautgauche8 = new JPanel();
		bashaut8.add(bashautgauche8,BorderLayout.EAST);
		//panneau pour afficher le texte1
		JPanel bashautmilieu8= new JPanel();
		bashaut8.add(bashautmilieu8,BorderLayout.CENTER);
		//panneau pour le boutons modifier
		...
		//panneau pour libellé/ texte /bouttons
		JPanel bashaut9 = new JPanel();
		bas.add(bashaut9,BorderLayout.NORTH);
		bashaut9.setLayout(new GridLayout(1,2));
		//panneau pour label1
		JPanel bashautgauche9 = new JPanel();
		bashaut9.add(bashautgauche9,BorderLayout.EAST);

		//panneau pour le texte
		JPanel bashautdroit9 = new JPanel();
		bashaut9.add(bashautdroit9,BorderLayout.WEST);	
		
		JTextField texte = new JTextField();
		texte.setPreferredSize(new Dimension(150, 50));
		texte.setFont(police1);
		bashautgauche9.add(label9);
		bashautdroit9.add(texte);
		...
		JButton button8 = new JButton("modifier");
		button8.addActionListener(new ControleRecap(4,numClient,this));
		...
		new Recuperation_des_donnes(numClient,"Magazine",bashautmilieu8);
		bashautdroit8.add(button8);
